<template>
    <div class="footer">
        <div class="footer__content">
          ...
          <p class="footer__content__text">It is a long established fact that a reader will be distracted lookings.</p>
      ...
      <div class="footer__contact">
          ...
          <p>55 East Birchwood Ave. Brooklyn, New York 11201 <br><br>contact@interno.com <br><br>(123) 456 - 7890</p>
      </div>
    </div>
</template>
